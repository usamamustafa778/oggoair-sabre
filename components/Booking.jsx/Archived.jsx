        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 p-6">
              <div className="w-full md:w-48 lg:w-56 h-40 md:h-auto flex-shrink-0 animate-pulse bg-gray-200 rounded-lg"></div>
          ...
          <div className="p-12 lg:p-16">
            <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base md:text-lg text-gray-500 leading-relaxed max-w-lg mx-auto">
                  You don't have any archived bookings yet.
                </p>
              </div>
            </div>
          </div>
        ...
        return (
          <ArchivedCard
            ...
            booking={{
              ...
              originStation: routeInfo.originStation,
              destination: routeInfo.destination,
              destinationStation: routeInfo.destinationStation,
